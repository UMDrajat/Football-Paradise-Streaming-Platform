  ...
  function MainMenuFirstSection() {
    ...
    if (
      ...
      items.push({
        ...
        icon: 'done_outline',
        text: translateString("Recommended1"),
	...
	items.push({
    link: '/live-streaming', // The path for your live streaming page
    icon: 'live_tv', // Material icon for live streaming
    text: translateString('Live Streaming'),
    className: 'nav-item-live-streaming',
	});
