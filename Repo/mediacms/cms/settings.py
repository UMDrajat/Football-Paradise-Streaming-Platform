...
TEMPLATES = [
    {
        ...
        'DIRS': ['/mnt/c/raunak/UMD/Courses/Sem II/BUDT748/finalproject/mediacms/templates'],
        "APP_DIRS": True,
        "OPTIONS": {
            "context_processors": [
...
DATABASES = {
    'default': {
        ...
        'NAME': 'mediacms_db',  # Ensure this matches your database name
        'USER': 'raunak',      # Ensure this matches your PostgreSQL username
        'PASSWORD': 'mediapass',  # Replace with the actual password
        'HOST': '127.0.0.1',
        'PORT': '5432',
    }
}
